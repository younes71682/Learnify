      ...
      {pending_data_Show_Information ?
        ...
        <FormProvider {...methods}>
          ...
          <Layout_profil_user>
            ...
            <div className='flex flex-col gap-6 w-[64%] h-[112vh] max-lg:w-[80%]'>

              <div className='flex  justify-between gap-6'>
                <div className='flex flex-col items-start gap-4 px-4 pt-5 rounded-[15px] shadow-[0_0_20px_rgba(0,0,0,0.05)] '>
                  ...
                  <form className='flex flex-wrap' onSubmit={handleSubmit(onSubmit)} noValidate>
                    ...
                    <div className='flex flex-col gap-1 h-[71px] ml-4'>
                      <input {...register("name", { required: true })} defaultValue={name} placeholder='*نام' className='border-solid border-[0.5px] border-[#AAAAAA] rounded-[10px] w-[210px] h-[48px] pr-2 outline-[#008000] ' />
                      {errors.name?.type === "required" && <p className='text-red-500 font-normal text-xs'>نام خود را وارد کنید</p>}
                    </div>

                    <div className='flex flex-col gap-1 h-[71px] ml-4'>
                      <input {...register("family", { required: true })} defaultValue={family} placeholder='*نام خانوادگی' className='border-solid border-[0.5px] border-[#AAAAAA] rounded-[10px] w-[210px] h-[48px] pr-2 outline-[#008000]  ' />
