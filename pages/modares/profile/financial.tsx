    ...
    return (
        <div className='flex justify-center gap-6 h-[150vh] pt-24 '>
            ...
            <div className='flex flex-col gap-6 w-[64%]'>
                ...
                <div className='flex flex-col rounded-[15px] shadow-[0px_0px_20px_rgba(0,0,0,0.05)] h-[53vh]'>
                ...
                <div className='flex  justify-between'>
                    <div className='flex flex-col rounded-[15px] shadow-[0px_0px_20px_rgba(0,0,0,0.05)] w-[63%] h-[56vh]'>
                        <div className='bg-red-500 flex p-4'><h3>نمودار وضعیت دوره براساس ماه</h3></div>
