        ...
        <div className='flex flex-wrap justify-center mx-32'>
            {informatin.map((item) => {
                return (
                    ...
                    <Link href={`/user/courses`} className='mx-12 my-8 border-solid  border-[#008000] border-2 rounded-[15px] w-44 h-[108px] hover:text-white hover:shadow-[inset_0_-10rem] hover:shadow-[#008000] duration-[700ms,700ms] transition-[color,box-shadow]'>
