...
const CourseComponent = (props: any) => {
    const { name, title, detail, description, seasons, duration, price, imageURL, id, user_id, } = props
    ...
    return (
        <div className='flex flex-col items-center justify-between bg-white shadow-[0_0px_20px_rgb(0,0,0,0.1)] rounded-[10px] w-full h-full'>
            ...
            <div className='flex justify-center w-[88%] h-[144px] rounded-[15px] mt-3'>
                {/* {image} */}
                <img className='w-full bg-contain' src='/medium_shot_woman_presenting.png' alt='Medium_Shot_Woman_Presenting' />
            </div>
