...
export const Step2 = () => {
    ...
    return (
        <div className='flex justify-center items-center w-[100%]'>
            <div className='bg-[#F4F4F4] rounded-[18px] shadow-[0px_0px_20px_rgba(0,0,0,0.1)] py-10 px-20 w-[100%]'>
                        ...
                        <div key={chapter.id} className='my-4 flex gap-2'>
                            <div className='flex flex-col w-[250px]'>
                                ...
                                <div>
                                    ...
                                    }} placeholder='عنوان فصل' className='w-[206px] px-2 border-solid border-2 border-[#AAAA] rounded-[10px] h-[56px] outline-[#008000]' />
                                </div>
                            </div>
                            ...
                            <div className='w-full'>
                                ...
                                {chapter.lessons.map((lesson, lessonIndex) => {
                                    return (
                                        <div key={lesson.id} className='mr-12 flex justify-between mb-4'>
                                            <div className='flex flex-col w-[204px]'>
                                                ...
                                                <div>
                                                    ...
                                                    }} placeholder='عنوان درس' className='w-[206px] px-2 border-solid border-2 border-[#AAAA] rounded-[10px] h-[56px] outline-[#008000]' />
                                                </div>
                                            </div>
                                            ...
                                            <div className='flex flex-col  w-[206px]'>
                                                ...
                                                <div>
                                                    <input value={lesson.time}
                                                        onChange={(e) => {
                                                            setLessonTime(e.target.value);
                                                            handleLessonTime(chapter.id, lesson.id, e.target.value);
                                                        }}
                                                        placeholder='47 دقیقه' className='w-[206px] px-2 border-solid border-2 border-[#AAAA] rounded-[10px] h-[56px] outline-[#008000]' />
                                                </div>
